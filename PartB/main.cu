...
int main(int argc, char *argv[])
{
	...
	// end = TIME_NOW;
	// cout<<"Reference Time: "<<(double) TIME_DIFF(std::chrono::microseconds,begin,end)/1000.0<<"ms\n";
	...
	cout<<"GPU Time: "<<(double) TIME_DIFF(std::chrono::microseconds,begin,end)/1000.0<<"ms\n";
